...
function addDefault() {
    ...
    defaultTodo1.tasks.push(new Task("Do this", "Description", "2025-03-10T15:30", "Priority"));
    defaultTodo1.tasks.push(new Task("Do that", "Description", "2025-12-25T08:15", "Priority"));
    const defaultTodo2 = TodoList.addTodo("Test", "Incomplete");
    defaultTodo2.tasks.push(new Task("Title", "Description", "2026-07-04T19:45", "Priority"));
